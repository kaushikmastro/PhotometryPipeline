...
echo "DSK in metakernel: $(grep vesta_gaskell_256 data/02_spice_kernels/dawn_dynamic.tm)"
echo "DSK size on disk:  $(stat -c '%s %n' data/02_spice_kernels/vesta_gaskell_256_110825.bds)"

python scripts/run_geometry_110825.py
