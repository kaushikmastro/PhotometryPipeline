...
Reads all Survey F1B geometry parquets from
  data/04_geometry_tables_dsk256_110825/survey/
and combines them (no sampling — full dataset) into
  data/06_silver_layer_dsk256/combined_survey_sample_110825.parquet
...
INPUT_GLOB = str(ROOT / "data" / "04_geometry_tables_dsk256_110825" / "survey" / "*.parquet")
OUTPUT    = ROOT / "data" / "06_silver_layer_dsk256" / "combined_survey_sample_110825.parquet"
