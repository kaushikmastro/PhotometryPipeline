#!/bin/bash
#SBATCH --job-name=lamo_allletter
#SBATCH --output=/home/kaushim07/photometry_mcmc_env/logs/lamo_allletter_%j.log
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "========================================================"
echo "LAMO all-letter job: slice=${SLICE_FILE} workers=14"
echo "========================================================"
