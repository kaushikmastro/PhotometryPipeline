...
Input:  01_calibrated_images/survey/ — 844 genuine Survey F1B images
...
OUTPUT_SUBDIR  = "04_geometry_tables_ellipsoid"
...
def main() -> None:
    ...
    if args.image:
        ...
        all_f1b = sorted(
            (DATA_ROOT / "01_calibrated_images" / "survey").glob("*F1B*.IMG")
        )
