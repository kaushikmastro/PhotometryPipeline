...
Input parquet patterns:
    data/geometry/dsk256/hamo/*.parquet  ← f_solar=892 (CORRECT)
Output parquet:
    data/silver/dsk256/hamo_dsk256_110825.parquet
"""
...
INPUT_GLOBS = ['data/geometry/dsk256/hamo/*.parquet']
...
def main() -> None:
    ...
    SELECT
        ...
        FROM read_parquet('data/geometry/dsk256/hamo/*.parquet')
