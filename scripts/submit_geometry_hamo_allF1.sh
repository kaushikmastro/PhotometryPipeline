...
# Input:  01_calibrated_images/hamo/ (5547 F1-any images: 1089 F1B + 4458 new)
...
IMG_DIR="${SCRATCH}/01_calibrated_images/hamo"
OUT_DIR="${SCRATCH}/04_geometry_tables_dsk256_110825/hamo_allF1"
F1B_DIR="${SCRATCH}/04_geometry_tables_dsk256_110825/hamo"
...
# ── Geometry grind ─────────────────────────────────────────────────────────
python scripts/run_geometry_hamo_allF1.py
...
out_dir = "/scratch/kaushim07/vesta_data/04_geometry_tables_dsk256_110825/hamo_allF1"
f1b_dir = "/scratch/kaushim07/vesta_data/04_geometry_tables_dsk256_110825/hamo"
