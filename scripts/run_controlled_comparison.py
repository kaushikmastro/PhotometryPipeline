...
Sources:
  ...
  110825 DSK:      data/04_geometry_tables_dsk256_110825/survey/*.parquet  (f_solar=892)

Outputs:
  data/06_silver_layer_dsk256/binned_prelim_1pct.parquet
  data/06_silver_layer_dsk256/binned_110825_1pct.parquet
...
Step 3 output:
  data/06_silver_layer_dsk256/scatter_characterisation_110825.parquet
"""
...
SILVER = ROOT / "data" / "06_silver_layer_dsk256"
...
D110_GLOB   = str(ROOT / "data" / "04_geometry_tables_dsk256_110825" / "survey" / "*.parquet")
