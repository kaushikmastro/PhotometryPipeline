...
Input parquet patterns:
    data/04_geometry_tables_dsk256_110825/survey/*.parquet  ← f_solar=892 (CORRECT)

Output parquet:
    data/06_silver_layer_dsk256/survey_dsk256_110825.parquet
"""
...
INPUT_GLOBS = ['data//04_geometry_tables_dsk256_110825/survey/*.parquet']
...
def main() -> None:
    ...
    SELECT
        ...
        FROM read_parquet('data/04_geometry_tables_dsk256_110825/survey/*.parquet')
